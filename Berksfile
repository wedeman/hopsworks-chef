...
cookbook 'kagent', github: "logicalclocks/kagent-chef", branch: "springclean"
cookbook 'hops', github: "logicalclocks/hops-hadoop-chef", branch: "springclean"
...
cookbook 'tensorflow', github: "logicalclocks/tensorflow-chef", branch: "springclean"
